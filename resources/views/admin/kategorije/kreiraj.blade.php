                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Kreiraj kategoriju</h4>
                            <span class="ml-1">Kategorije</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Kategorije</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="{{ config('app.url') . '/admin/kategorije' }}">
                                        @csrf
                                        <div class="form-group">
                                            <label for="" class="select2-container">
                                                Naziv <br>

                                                <input type="text" name="naziv" class="form-control input-default " placeholder="Naziv kategorije">
                                                @error('naziv') <span class="text-danger">{{ $message }}</span> @enderror
                                            </label>
                                        </div>
                                        <button type="submit" class="btn btn-primary mt-3">Kreiraj</button>
                                    </form>
                                </div>
                            </div>
                        </div>

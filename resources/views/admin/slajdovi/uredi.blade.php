                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="{{ config('app.url') . '/admin/slajdovi/' . $slide->id }}" enctype='multipart/form-data'>
                                        @method('PUT')
                                        @csrf
                                        <div class="form-group">
                                            <label for="" class="select2-container">
                                                ...
                                                <input type="text" name="naslov" value="{{ $slide->naslov }}" class="form-control input-default " placeholder="Naslov">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="select2-container">
                                                ...
                                                <input type="text" name="autor" value="{{ $slide->autor }}" class="form-control input-default " placeholder="Kratki opis">
                                        ...
                                        <div class="form-group">
                                            <label class="select2-label select2-container" for="id_label_single">
                                                ...
                                                <select name="redoslijed" class="select2-with-label-single js-states d-block form-control input-default" id="id_label_single">
                                                    <option disabled value>izaberi poziciju slajda</option>
                                                    <option {{ $slide->redoslijed === 1 ? 'selected' : '' }} value="1">1</option>
                                                    <option {{ $slide->redoslijed === 2 ? 'selected' : '' }} value="2">2</option>
                                                    <option {{ $slide->redoslijed === 3 ? 'selected' : '' }} value="3">3</option>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            <label for="" class="select2-container">
                                                ...
                                                <input type="text" name="link" value="{{ $slide->link }}" class="form-control input-default " placeholder="Link">

                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="{{ config('app.url') . '/admin/novosti/' . $post->id }}" enctype='multipart/form-data'>
                                        @method('PUT')
                                        @csrf
                                        <div class="form-group">
                                            <label for="" class="select2-container">
                                                ...
                                                <input type="text" name="naslov" value="{{ $post->naslov }}" class="form-control input-default " placeholder="Naslov">

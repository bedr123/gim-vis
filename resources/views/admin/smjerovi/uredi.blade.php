                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="{{ config('app.url') . '/admin/smjerovi/' . $direction->id }}" enctype='multipart/form-data'>
                                        @method('PUT')
                                        @csrf
                                        <div class="form-group">
                                            <label for="" class="select2-container">
                                                ...
                                                <input type="text" name="naziv" value="{{ $direction->naziv }}" class="form-control input-default " placeholder="Naziv">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="select2-container">
                                                ...
                                                <textarea name="opis" id="" class="form-control input-default" cols="30" rows="10">{{ $direction->opis }}</textarea>

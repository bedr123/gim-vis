                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Kreiraj smijer</h4>
                            <span class="ml-1">Smjerovi</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Smjerovi</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="{{ config('app.url') . '/admin/smjerovi' }}" enctype='multipart/form-data'>
                                        @csrf
                                        <div class="form-group">
                                            <label for="" class="select2-container">
                                                Naziv <br>

                                                <input type="text" name="naziv" class="form-control input-default " placeholder="Naziv">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="select2-container">
                                                ...
                                                <textarea name="opis" class="form-control input-default" id="" cols="30" rows="10"></textarea>
                                            ...
                                            <label for="custom-file" class="select2-label select2-container">
                                                ...
                                                <div class="input-group mb-3">
                                                    <div class="custom-file">
                                                        <input type="file" name="ikonica" class="custom-file-input" id="custom-file">
                                                        <label class="custom-file-label">Izaberi fajl</label>
                                                    </div>
                                                </div>
                                                @error('ikonica') <span class="text-danger">{{ $message }}</span> @enderror
                                            </label>
                                        </div>
                                        <div class="form-group">

        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <a href="{{ config('app.url') . '/admin/raspored/kreiraj' }}"><button type="button" class="btn btn-rounded btn-primary pr-4"><span
                        class="btn-icon-left text-primary"><i class="fa fa-plus color-primary"></i></span>Novi raspored</button></a>
                    </div>
                </div>

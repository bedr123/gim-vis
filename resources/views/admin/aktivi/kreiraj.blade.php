                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="{{ config('app.url') . '/admin/aktivi' }}" enctype='multipart/form-data'>
                                        @csrf
                                        <div class="form-group">
                                            <label for="" class="select2-container">
                                                Naziv <br>

                                                <input type="text" name="naziv" class="form-control input-default " placeholder="Naziv aktiva">
                                        ...
                                        <div class="form-group">
                                            <label class="select2-label select2-container" for="id_label_multiple">
                                                ...
                                                <select name="predsjednik" class="select2-with-label-multiple js-states form-control input-default" id="id_label_multiple">
                                                    <option disabled selected value>izaberi predsjednika</option>

                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Učenici Gimnazije</h4>
                            <p class="mb-0">Dodaj nove učenike</p>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <a href="{{ config('app.url') . '/admin/ucenici/kreiraj' }}"><button type="button" class="btn btn-rounded btn-primary pr-4"><span
                        class="btn-icon-left text-primary"><i class="fa fa-plus color-primary"></i></span>Dodaj učenika</button></a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">SVI UČENICI</h4>
                            </div>
                            <div class="card-body">

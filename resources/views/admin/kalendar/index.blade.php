                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Nastavni kalendar</h4>
                            <p class="mb-0">Novi kalendar</p>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <a href="{{ config('app.url') . '/admin/kalendar/kreiraj' }}"><button type="button" class="btn btn-rounded btn-primary pr-4"><span
                        class="btn-icon-left text-primary"><i class="fa fa-plus color-primary"></i></span>Novi kalendar</button></a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Kalendar</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-responsive-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>1</th>
                                                <td>
                                                    <img height="200px" src="{{ $calendar->slika }}" />
                                                </td>
                                                <td class="d-flex flex-column align-items-start">
                                                    <form action="{{ config('app.url') . '/admin/kalendar/' . $calendar->id }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
